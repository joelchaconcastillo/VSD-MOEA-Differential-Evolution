...
const double UF4::PI = 3.141592653589793;

UF4::UF4(string solutionType, int numberOfVariables, int numberOfObjectives) {
...
void UF4::evaluate(Solution *solution) {
	...
	fx_[1] = 1.0 - x_[0]*x_[0] + 2.0*sum2 / (double)count2;	
