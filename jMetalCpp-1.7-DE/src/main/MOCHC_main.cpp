...
//	indicators = NULL ;
  ...
  string FileNameObjective = DirReport + "/OBJ_MOCHC_SBX_POLYNOMIAL_EVALUATIONS_" +to_string(maxEvaluations) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
  string FileNameVariable = DirReport + "/VAR_MOCHC_SBX_POLYNOMIAL_EVALUATIONS_" +to_string(maxEvaluations) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
