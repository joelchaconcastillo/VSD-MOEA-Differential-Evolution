...
// Los primeros dos argumentos es el nombre del programa + Nombre del algoritmo + Instancia + Numero de variables + Numero de objetivos + Semilla
  ...
  string FileNameObjective = DirReport + "/OBJ_PAES_POLYNOMIAL_EVALUATIONS_" +to_string(maxEvaluationsValue) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
  string FileNameVariable = DirReport + "/VAR_PAES_POLYNOMIAL_EVALUATIONS_" +to_string(maxEvaluationsValue) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
  ...
  double distributionIndexValue1 = 50.0;
