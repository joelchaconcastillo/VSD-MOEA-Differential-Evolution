...
// Los primeros dos argumentos es el nombre del programa + Nombre del algoritmo + Instancia + Numero de variables + Numero de objetivos + Semilla
  ...
  int maxIterationsValue = 250000;
 string FileNameObjective = DirReport + "/OBJ_SMPSO_POLYNOMIAL_ITERATIONS_" +to_string(maxIterationsValue) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
  string FileNameVariable = DirReport + "/VAR_SMPSO_POLYNOMIAL_ITERATIONS_" +to_string(maxIterationsValue) +"_"+problem->getName() +"_SEED_"+to_string(Seed)+".txt";
